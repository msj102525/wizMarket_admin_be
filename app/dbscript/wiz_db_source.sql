...
DROP TABLE IF EXISTS `LOCAL_STORE`;
...
DROP TABLE IF EXISTS `DETAIL_CATEGORY_MAPPING`;
...
CREATE TABLE
    `COMMERCIAL_DISTRICT` (
        ...
        `MARKET_SIZE` BIGINT NULL COMMENT '시장 규모',
        `AVERAGE_SALES` BIGINT NULL COMMENT '평균 매출',
...
CREATE TABLE
    `LOCAL_STORE` (
        ...
        `KAKAO_REVIEW_SCORE` FLOAT COMMENT '카카오 평점',
        `KAKAO_REVIEW_COUNT` INT COMMENT '카카오 평점 갯수',
        `MENU_1` VARCHAR(100) COMMENT '메뉴 1',
        `MENU_1_PRICE` INT COMMENT '메뉴 1 가격',
        `MENU_2` VARCHAR(100) COMMENT '메뉴 2',
        `MENU_2_PRICE` INT COMMENT '메뉴 2 가격',
        `MENU_3` VARCHAR(100) COMMENT '메뉴 3',
        `MENU_3_PRICE` INT COMMENT '메뉴 3 가격',
        ...
        `IS_EXIST` TINYINT NULL COMMENT '존재여부',
...
CREATE TABLE
    `POPULATION_AGE` (
        ...
        `REFERENCE_ID` INT NOT NULL COMMENT '출처 ID',
        `REF_DATE` DATE NOT NULL COMMENT '기준 날짜',
...
CREATE TABLE
    `COMMERCIAL_DISTRICT_SUB_DISTRICT_DENSITY_STATISTICS` (
        ...
        `J_SCORE_RANK` FLOAT NOT NULL COMMENT 'J_SCORE_RANK',
        `J_SCORE_PER` FLOAT NOT NULL COMMENT 'J_SCORE_PER',
...
CREATE TABLE
    `COMMERCIAL_DISTRICT_WEIGHTED_AVERAGE` (
        ...
        `BIZ_SUB_CATEGORY_ID` INT NOT NULL COMMENT 'FK_BSCID',
        `BIZ_DETAIL_CATEGORY_ID` INT NOT NULL COMMENT 'FK_BDID',
        `J_SCORE_RANK_AVG` FLOAT NOT NULL COMMENT 'J_SCORE_RANK_AVG',
        `J_SCORE_PER_AVG` FLOAT NOT NULL COMMENT 'J_SCORE_PER_AVG',
        `J_SCORE_AVG` FLOAT NOT NULL COMMENT 'J_SCORE_AVG',
        `STAT_LEVEL` VARCHAR(10) NOT NULL COMMENT '참조레벨',
        `REF_DATE` DATE NOT NULL COMMENT '기준년월',
        `CREATED_AT` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '생성날짜',
        PRIMARY KEY (`CDWA_ID`),
