...
CREATE TABLE
    `CITY` (
        `CITY_ID` INT NOT NULL COMMENT 'PK_CID',
...
CREATE TABLE
    `DISTRICT` (
        `DISTRICT_ID` INT NOT NULL COMMENT 'PK_DID',
...
CREATE TABLE
    `SUB_DISTRICT` (
        `SUB_DISTRICT_ID` INT NOT NULL COMMENT 'PK_SDID',
        `CITY_ID` INT NOT NULL COMMENT 'FK_CID',
...
CREATE TABLE
    `BIZ_MAIN_CATEGORY` (
        `BIZ_MAIN_CATEGORY_ID` INT NOT NULL COMMENT 'PK_BMCID',
...
CREATE TABLE
    `BIZ_SUB_CATEGORY` (
        `BIZ_SUB_CATEGORY_ID` INT NOT NULL COMMENT 'PK_BSCID',
...
CREATE TABLE
    `BIZ_DETAIL_CATEGORY` (
        `BIZ_DETAIL_CATEGORY_ID` INT NOT NULL COMMENT 'PK_BDID',
...
CREATE TABLE
    `COMMERCIAL_DISTRICT` (
        `COMMERCIAL_DISTRICT_ID` INT NOT NULL COMMENT 'PK_CDID',
        `CITY_ID` INT NOT NULL COMMENT 'FK_CID',
        `DISTRICT_ID` INT NOT NULL COMMENT 'FK_DID',
        ...
        FOREIGN KEY (`BIZ_MAIN_CATEGORY_ID`) REFERENCES `BIZ_MAIN_CATEGORY` (`BIZ_MAIN_CATEGORY_ID`),
        FOREIGN KEY (`BIZ_SUB_CATEGORY_ID`) REFERENCES `BIZ_SUB_CATEGORY` (`BIZ_SUB_CATEGORY_ID`),
        FOREIGN KEY (`BIZ_DETAIL_CATEGORY_ID`) REFERENCES `DETAIL_CATEGORY` (`BIZ_DETAIL_CATEGORY_ID`)
    );

CREATE TABLE
    `RISING_BUSINESS` (
        `RISING_BUSINISS_ID` INT NOT NULL COMMENT 'PK_RBID',
        `CITY_ID` INT NOT NULL COMMENT 'FK_CID',
        `DISTRICT_ID` INT NOT NULL COMMENT 'FK_DID',
        `SUB_DISTRICT_ID` INT NOT NULL COMMENT 'FK_SDID',
        `BIZ_MAIN_CATEGORY_ID` INT NOT NULL COMMENT 'FK_BMCID',
        ...
        `CREATED_AT` DATETIME NOT NULL COMMENT '생성일시',
        `UPDATED_AT` DATETIME NOT NULL COMMENT '수정일시',
        PRIMARY KEY (`RISING_BUSINISS_ID`),
        FOREIGN KEY (`CITY_ID`) REFERENCES `CITY` (`CITY_ID`),
        FOREIGN KEY (`DISTRICT_ID`) REFERENCES `DISTRICT` (`DISTRICT_ID`),
        FOREIGN KEY (`SUB_DISTRICT_ID`) REFERENCES `SUB_DISTRICT` (`SUB_DISTRICT_ID`),
        FOREIGN KEY (`BIZ_MAIN_CATEGORY_ID`) REFERENCES `BIZ_MAIN_CATEGORY` (`BIZ_MAIN_CATEGORY_ID`),
...
CREATE TABLE
    `LOC_INFO` (
        `LOC_INFO_ID` INT NOT NULL COMMENT 'PK_LIID',
        `CITY_ID` INT NOT NULL COMMENT 'FK_CID',
        `DISTRICT_ID` INT NOT NULL COMMENT 'FK_DID',
        `SUB_DISTRICT_ID` INT NOT NULL COMMENT 'FK_SDID',
        `BIZ_MAIN_CATEGORY_ID` INT NOT NULL COMMENT 'FK_BMCID',
...
-- 외래 키 제약 조건을 다시 활성화 ** 전체실행시 반드시 마지막에 실행
SET
