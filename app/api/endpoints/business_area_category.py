...
from app.service.business_area_category import (
    get_all_b_a_c_main_category as service_get_all_b_a_c_main_category,
    get_all_b_a_c_sub_category_by_main_category_code as service_get_all_b_a_c_sub_category_by_main_category_code,
    get_all_b_a_c_detail_category_by_sub_category_code as service_get_all_b_a_c_detail_category_by_sub_category_code,
)
...
def get_all_b_a_c_main_category(
    ...
    try:
        results = service_get_all_b_a_c_main_category(reference_id)
        return results
...
def get_all_b_a_c_sub_category_by_main_category_id(
    main_category_code: str = Query(True),
):
    try:
        results = service_get_all_b_a_c_sub_category_by_main_category_code(
            main_category_code
        )
        return results
    except HTTPException as http_ex:
